...
In this tutorial, we will look at a surplus production model. The .dat file name is called "surp_prod1.dat". You can name the .tpl file anything, but in this tutorial, it will be called "2_surp_prod_jitter.tpl".
...
The R helper functions ("base_funs.r") has a function "compile_admb.r" which will compile ADMB using a R command and through the R environment. The .tpl name in this tutorial is called "2_surp_prod_jitter".
