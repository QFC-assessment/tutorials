...
In this tutorial, we will look at a surplus production model. The .dat file name is called `surp_prod1.dat`. You can name the .tpl file anything, but in this tutorial, it will be called `3_surp_prod_lp.tpl`.
...
Finished running model '3_surp_prod_lp' after 0.04 s.
```
