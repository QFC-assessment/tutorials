...
<label><input type="checkbox" unchecked/> Likelihood profiles for important parameters are reasonable, e.g.: </label>\
        <label><input type="checkbox" unchecked/> Initial abundance </label>\
        <label><input type="checkbox" unchecked/> Recruitment </label>

        <label><input type="checkbox" unchecked/> Selectivity </label>\
 
